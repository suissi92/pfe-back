...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and().csrf().disable().authorizeRequests().antMatchers("/api/auth/**").permitAll()
				.antMatchers("/admin/**").permitAll().antMatchers("/lm/line/**").permitAll()
				.antMatchers("/admin/machine/**").permitAll().antMatchers("/reservation-machine/**").permitAll()
				.antMatchers("/reservation-line/**").permitAll().anyRequest().authenticated().and().exceptionHandling()
